...
export default function Pay() {
  return (
    <>
      <div className="w-full h-[32rem] bg-white rounded-3xl shadow-md mt-28 mb-20">
        <div className="flex justify-center pt-10 font-bold text-2xl font-[Ubuntu]">
          <div>Үйлчилгээний төлбөр</div>
        </div>
        <div className="flex justify-evenly">
          <div className="flex pt-12">
            <div className="w-96 h-44  flex flex-col items-center pt-4 rounded-2xl border-2 border-gray">
          ...
          <div className="flex pt-12 drop-shadow-xl">
            <div className="w-96 h-44  flex flex-col items-center pt-4 rounded-2xl border-2 border-gray">
              <div className="font-[Ubuntu] font-bold pb-2">Junior</div>
              <div className="w-80 h-0.5 rounded-lg bg-secondary "></div>
              <div className="flex gap-4 pt-2">

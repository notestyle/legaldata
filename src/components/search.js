...
export default function Search() {
  return (
    <>
      ...
      <div className="lg:w-screen w-full h-full sticky top-20 z-20 flex justify-center bg-white1">
        <div className="flex justify-center w-full px-10 md:px-20 lg:px-52">
